...
struct is_explicitly_constructible_t
  : std::bool_constant<std::is_constructible_v<T, TArg, TArgs...> &&
                       !std::is_convertible_v<TArg, T>>
{
};
...
constexpr bool is_explicitly_constructible_v =
  is_explicitly_constructible_t<T, TArg, TArgs...>::value;
...
struct is_implicitly_constructible_t
  : std::bool_constant<std::is_constructible_v<T, TArg, TArgs...> && std::is_convertible_v<TArg, T>>
{
};
