...
protected:
  ...
  explicit Exception(std::string message, const std::source_location & location,
...
public:
  ...
  explicit InvalidArgumentException(std::string_view argument, std::string_view format,
                                    TArgs &&... args) noexcept
    : Exception(std::format("Invalid argument provided: {}. {}", argument,
...
public:
  ...
  const std::string & argument() const noexcept { return m_argument; }
};
...
public:
  ...
  /// <param name="message">The error message.</param>
  template<typename T>
  explicit ArgumentOutOfRangeException(std::string_view argument, T fromInclusive, T toExclusive,
                                       T value, std::string_view message) noexcept
    : Exception(
        std::format(
          "Argument was out of range: {} (valid range is [{}, {}) but actual value was {}). {}",
          argument, fromInclusive, toExclusive, value, message),
        std::source_location::current(), std::stacktrace::current())
    , m_argument(argument)
  {
  }
  ...
  /// <param name="args">The arguments passed to the error message format string.</param>
  template<typename... TArgs>
  explicit ArgumentOutOfRangeException(std::string_view argument, std::string_view format,
                                       TArgs &&... args) noexcept
    : Exception(std::format("Argument was out of range: {}. {}", argument,
                            std::vformat(format, std::make_format_args(args...))),
                std::source_location::current(), std::stacktrace::current())
  ...
  explicit ArgumentOutOfRangeException(std::string_view argument, T fromInclusive, T toExclusive,
                                       T value, std::string_view format, TArgs &&... args) noexcept
    : Exception(
        std::format(
          "Argument was out of range: {} (valid range is [{}, {}) but actual value was {}). {}",
          argument, fromInclusive, toExclusive, value,
          std::vformat(format, std::make_format_args(args...))),
        std::source_location::current(), std::stacktrace::current())
    , m_argument(argument)
  {
...
public:
  ...
  /// <param name="args">The arguments passed to the error message format string.</param>
  template<typename... TArgs>
  explicit ArgumentNotInitializedException(std::string_view argument, std::string_view format,
                                           TArgs &&... args) noexcept
    : Exception(std::format("Argument was not initialized: {}. {}", argument,
                            std::vformat(format, std::make_format_args(args...))),
                std::source_location::current(), std::stacktrace::current())
...
public:
  ...
  explicit RuntimeException() noexcept
    : Exception("The operation could not be executed.", std::source_location::current(),
  ...
  explicit RuntimeException(std::string_view format, TArgs &&... args) noexcept
    : Exception(std::format("The operation could not be executed: {}",
                            std::vformat(format, std::make_format_args(args...))),
                std::source_location::current(), std::stacktrace::current())
  {
  }
