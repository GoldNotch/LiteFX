...
class VulkanIndexBufferLayout::VulkanIndexBufferLayoutImpl
  : public Implement<VulkanIndexBufferLayout>
{
public:
...
UInt32 VulkanIndexBufferLayout::binding() const noexcept { return m_impl->m_binding; }

BufferType VulkanIndexBufferLayout::type() const noexcept { return m_impl->m_bufferType; }

IndexType VulkanIndexBufferLayout::indexType() const noexcept { return m_impl->m_indexType; }
