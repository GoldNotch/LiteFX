...
public:
  void initialize(Enumerable<UniquePtr<VulkanVertexBufferLayout>> && vertexBufferLayouts,
...
VulkanInputAssembler::VulkanInputAssembler(
  ...
  UniquePtr<VulkanIndexBufferLayout> && indexBufferLayout, PrimitiveTopology primitiveTopology)
...
Enumerable<const VulkanVertexBufferLayout *> VulkanInputAssembler::vertexBufferLayouts()
  const noexcept
{
...
class VulkanInputAssemblerBuilder::VulkanInputAssemblerBuilderImpl
  : public Implement<VulkanInputAssemblerBuilder>
{
public:
...
VulkanInputAssemblerBuilder::VulkanInputAssemblerBuilder() noexcept
  : m_impl(makePimpl<VulkanInputAssemblerBuilderImpl>(this))
  , InputAssemblerBuilder(SharedPtr<VulkanInputAssembler>(new VulkanInputAssembler()))
{
}
...
VulkanVertexBufferLayoutBuilder VulkanInputAssemblerBuilder::vertexBuffer(size_t elementSize,
                                                                          UInt32 binding)
{
  return VulkanVertexBufferLayoutBuilder(*this, makeUnique<VulkanVertexBufferLayout>(elementSize,
                                                                                     binding));
}
