...
class LITEFX_VULKAN_API IVulkanBuffer : public virtual IBuffer,
                                        public virtual IResource<VkBuffer>
{
public:
...
class LITEFX_VULKAN_API IVulkanVertexBuffer : public virtual VertexBuffer<VulkanVertexBufferLayout>,
                                              public virtual IVulkanBuffer
{
public:
...
/// <seealso cref="VulkanIndexBufferLayout" />
/// <seealso cref="IVulkanBuffer" />
class LITEFX_VULKAN_API IVulkanIndexBuffer : public virtual IndexBuffer<VulkanIndexBufferLayout>,
                                             public virtual IVulkanBuffer
{
public:
...
class LITEFX_VULKAN_API IVulkanImage : public virtual IImage,
                                       public virtual IResource<VkImage>
{
public:
...
/// <seealso cref="VulkanDescriptorSetLayout" />
/// <seealso cref="IVulkanImage" />
class LITEFX_VULKAN_API IVulkanSampler : public virtual ISampler,
                                         public virtual IResource<VkSampler>
{
public:
...
class LITEFX_VULKAN_API IVulkanAccelerationStructure
  : public virtual IAccelerationStructure,
    public virtual IResource<VkAccelerationStructureKHR>
{
public:
...
class LITEFX_VULKAN_API VulkanBottomLevelAccelerationStructure final
  : public IBottomLevelAccelerationStructure,
    public virtual IVulkanAccelerationStructure,
    public virtual StateResource,
    public virtual Resource<VkAccelerationStructureKHR>
{
...
public:
  ...
  explicit VulkanBottomLevelAccelerationStructure(
...
public:
  ...
  /// <inheritdoc />
  void build(const VulkanCommandBuffer & commandBuffer,
             SharedPtr<const IVulkanBuffer> scratchBuffer = nullptr,
             SharedPtr<const IVulkanBuffer> buffer = nullptr, UInt64 offset = 0,
             UInt64 maxSize = 0);

  /// <inheritdoc />
  void update(const VulkanCommandBuffer & commandBuffer,
              SharedPtr<const IVulkanBuffer> scratchBuffer = nullptr,
              SharedPtr<const IVulkanBuffer> buffer = nullptr, UInt64 offset = 0,
              UInt64 maxSize = 0);

  /// <inheritdoc />
  void copy(const VulkanCommandBuffer & commandBuffer,
            VulkanBottomLevelAccelerationStructure & destination, bool compress = false,
            SharedPtr<const IVulkanBuffer> buffer = nullptr, UInt64 offset = 0,
...
/// </summary>
/// <seealso cref="VulkanBottomLevelAccelerationStructure" />
class LITEFX_VULKAN_API VulkanTopLevelAccelerationStructure final
...
public:
  ...
  /// <exception cref="InvalidArgumentException">Thrown if the provided <paramref name="flags" /> contain an unsupported combination of flags.</exception>
  /// <seealso cref="AccelerationStructureFlags" />
  explicit VulkanTopLevelAccelerationStructure(
    AccelerationStructureFlags flags = AccelerationStructureFlags::None, StringView name = "");
...
public:
  ...
  /// <inheritdoc />
  void copy(const VulkanCommandBuffer & commandBuffer,
            VulkanTopLevelAccelerationStructure & destination, bool compress = false,
            SharedPtr<const IVulkanBuffer> buffer = nullptr, UInt64 offset = 0,
            bool copyBuildInfo = true) const;
...
public:
  ...
  /// <inheritdoc />
  void transition(const IVulkanBuffer & buffer, ResourceAccess accessBefore,
                  ResourceAccess accessAfter) override;

  /// <inheritdoc />
  void transition(const IVulkanBuffer & buffer, UInt32 element, ResourceAccess accessBefore,
                  ResourceAccess accessAfter) override;

  /// <inheritdoc />
  void transition(const IVulkanImage & image, ResourceAccess accessBefore,
  ...
  /// <inheritdoc />
  void transition(const IVulkanImage & image, UInt32 level, UInt32 levels, UInt32 layer,
...
class LITEFX_VULKAN_API VulkanShaderModule final : public IShaderModule,
...
public:
  ...
  explicit VulkanShaderModule(
    const VulkanDevice & device, ShaderStage type, const String & fileName,
  ...
  /// <param name="shaderLocalDescriptor">The descriptor that binds shader-local data for ray-tracing shaders.</param>
  explicit VulkanShaderModule(
    const VulkanDevice & device, ShaderStage type, std::istream & stream, const String & name,
    const String & entryPoint = "main",
    const Optional<DescriptorBindingPoint> & shaderLocalDescriptor = std::nullopt);
...
private:
  ...
  explicit VulkanShaderProgram(const VulkanDevice & device,
                               Enumerable<UniquePtr<VulkanShaderModule>> && modules);
...
public:
  ...
  /// <param name="device">The parent device of the shader program.</param>
  /// <param name="modules">The shader modules used by the shader program.</param>
  static SharedPtr<VulkanShaderProgram> create(
    const VulkanDevice & device, Enumerable<UniquePtr<VulkanShaderModule>> && modules);
...
/// </summary>
/// <seealso cref="VulkanDescriptorSetLayout" />
class LITEFX_VULKAN_API VulkanDescriptorSet final
  : public DescriptorSet<IVulkanBuffer, IVulkanImage, IVulkanSampler, IVulkanAccelerationStructure>,
    public Resource<VkDescriptorSet>
{
  LITEFX_IMPLEMENTATION(VulkanDescriptorSetImpl);

public:
  using base_type =
    DescriptorSet<IVulkanBuffer, IVulkanImage, IVulkanSampler, IVulkanAccelerationStructure>;
...
public:
  ...
  explicit VulkanDescriptorSet(const VulkanDescriptorSetLayout & layout,
...
public:
  /// <inheritdoc />
  void update(UInt32 binding, const IVulkanBuffer & buffer, UInt32 bufferElement = 0,
              UInt32 elements = 0, UInt32 firstDescriptor = 0) const override;

  /// <inheritdoc />
  void update(UInt32 binding, const IVulkanImage & texture, UInt32 descriptor = 0,
  ...
  /// <inheritdoc />
  void update(UInt32 binding, const IVulkanAccelerationStructure & accelerationStructure,
...
public:
  ...
  explicit VulkanDescriptorLayout(DescriptorType type, UInt32 binding, size_t elementSize,
...
class LITEFX_VULKAN_API VulkanDescriptorSetLayout final
  : public DescriptorSetLayout<VulkanDescriptorLayout, VulkanDescriptorSet>,
    public Resource<VkDescriptorSetLayout>
{
...
public:
  ...
  explicit VulkanDescriptorSetLayout(
    const VulkanDevice & device, Enumerable<UniquePtr<VulkanDescriptorLayout>> && descriptorLayouts,
    UInt32 space, ShaderStage stages);
...
public:
  /// <inheritdoc />
  UniquePtr<VulkanDescriptorSet> allocate(
  ...
  /// <inheritdoc />
  Enumerable<UniquePtr<VulkanDescriptorSet>> allocateMultiple(
...
public:
  ...
  explicit VulkanPushConstantsRange(ShaderStage shaderStage, UInt32 offset, UInt32 size,
...
/// <seealso cref="VulkanPushConstantsLayoutBuilder" />
class LITEFX_VULKAN_API VulkanPushConstantsLayout final
  : public PushConstantsLayout<VulkanPushConstantsRange>
{
...
public:
  ...
  explicit VulkanPushConstantsLayout(Enumerable<UniquePtr<VulkanPushConstantsRange>> && ranges,
                                     UInt32 size);
...
class LITEFX_VULKAN_API VulkanPipelineLayout final
  : public PipelineLayout<VulkanDescriptorSetLayout, VulkanPushConstantsLayout>,
    public Resource<VkPipelineLayout>
{
...
public:
  ...
  explicit VulkanPipelineLayout(
    ...
    Enumerable<UniquePtr<VulkanDescriptorSetLayout>> && descriptorSetLayouts,
...
class LITEFX_VULKAN_API VulkanInputAssembler final
  : public InputAssembler<VulkanVertexBufferLayout, VulkanIndexBufferLayout>
{
...
public:
  ...
  explicit VulkanInputAssembler(
    Enumerable<UniquePtr<VulkanVertexBufferLayout>> && vertexBufferLayouts,
    UniquePtr<VulkanIndexBufferLayout> && indexBufferLayout = nullptr,
...
public:
  ...
  explicit VulkanRasterizer(PolygonMode polygonMode, CullMode cullMode, CullOrder cullOrder,
                            Float lineWidth = 1.f,
...
class LITEFX_VULKAN_API VulkanPipelineState
  : public virtual Pipeline<VulkanPipelineLayout, VulkanShaderProgram>,
    public Resource<VkPipeline>
{
public:
...
public:
  ...
  virtual void bind(const VulkanCommandBuffer & commandBuffer,
                    Span<const VulkanDescriptorSet *> descriptorSets) const noexcept = 0;
};
...
class LITEFX_VULKAN_API VulkanCommandBuffer final
  : public CommandBuffer<VulkanCommandBuffer, IVulkanBuffer, IVulkanVertexBuffer,
                         IVulkanIndexBuffer, IVulkanImage, VulkanBarrier, VulkanPipelineState,
                         VulkanBottomLevelAccelerationStructure,
                         VulkanTopLevelAccelerationStructure>,
    public Resource<VkCommandBuffer>,
    public std::enable_shared_from_this<VulkanCommandBuffer>
{
  LITEFX_IMPLEMENTATION(VulkanCommandBufferImpl);

public:
  using base_type =
    CommandBuffer<VulkanCommandBuffer, IVulkanBuffer, IVulkanVertexBuffer, IVulkanIndexBuffer,
                  IVulkanImage, VulkanBarrier, VulkanPipelineState,
                  VulkanBottomLevelAccelerationStructure, VulkanTopLevelAccelerationStructure>;
...
public:
  ...
  /// <param name="begin">If set to <c>true</c>, the command buffer automatically starts recording by calling <see cref="begin" />.</param>
  /// <param name="primary"><c>true</c>, if the command buffer is a primary command buffer.</param>
  static inline SharedPtr<VulkanCommandBuffer> create(const VulkanQueue & queue, bool begin = false,
                                                      bool primary = true)
  {
...
public:
  ...
  /// <inheritdoc />
  [[nodiscard]] UniquePtr<VulkanBarrier> makeBarrier(
  ...
  /// <inheritdoc />
  void transfer(const IVulkanBuffer & source, const IVulkanBuffer & target,
                UInt32 sourceElement = 0, UInt32 targetElement = 0,
                UInt32 elements = 1) const override;

  /// <inheritdoc />
  void transfer(const void * const data, size_t size, const IVulkanBuffer & target,
                UInt32 targetElement = 0, UInt32 elements = 1) const override;

  /// <inheritdoc />
  void transfer(Span<const void * const> data, size_t elementSize, const IVulkanBuffer & target,
                UInt32 firstElement = 0) const override;

  /// <inheritdoc />
  void transfer(const IVulkanBuffer & source, const IVulkanImage & target, UInt32 sourceElement = 0,
                UInt32 firstSubresource = 0, UInt32 subresources = 1) const override;

  /// <inheritdoc />
  void transfer(const void * const data, size_t size, const IVulkanImage & target,
                UInt32 subresource = 0) const override;

  /// <inheritdoc />
  void transfer(Span<const void * const> data, size_t elementSize, const IVulkanImage & target,
                UInt32 firstSubresource = 0, UInt32 subresources = 1) const override;

  /// <inheritdoc />
  void transfer(const IVulkanImage & source, const IVulkanImage & target,
                UInt32 sourceSubresource = 0, UInt32 targetSubresource = 0,
                UInt32 subresources = 1) const override;

  /// <inheritdoc />
  void transfer(const IVulkanImage & source, const IVulkanBuffer & target,
                UInt32 firstSubresource = 0, UInt32 targetElement = 0,
                UInt32 subresources = 1) const override;

  /// <inheritdoc />
  void transfer(SharedPtr<const IVulkanBuffer> source, const IVulkanBuffer & target,
                UInt32 sourceElement = 0, UInt32 targetElement = 0,
                UInt32 elements = 1) const override;

  /// <inheritdoc />
  void transfer(SharedPtr<const IVulkanBuffer> source, const IVulkanImage & target,
                UInt32 sourceElement = 0, UInt32 firstSubresource = 0,
                UInt32 elements = 1) const override;

  /// <inheritdoc />
  void transfer(SharedPtr<const IVulkanImage> source, const IVulkanImage & target,
                UInt32 sourceSubresource = 0, UInt32 targetSubresource = 0,
                UInt32 subresources = 1) const override;

  /// <inheritdoc />
  void transfer(SharedPtr<const IVulkanImage> source, const IVulkanBuffer & target,
                UInt32 firstSubresource = 0, UInt32 targetElement = 0,
                UInt32 subresources = 1) const override;
  ...
  /// <inheritdoc />
  void bind(const VulkanDescriptorSet & descriptorSet,
            const VulkanPipelineState & pipeline) const noexcept override;

  /// <inheritdoc />
  void bind(Span<const VulkanDescriptorSet *> descriptorSets,
            const VulkanPipelineState & pipeline) const noexcept override;
  ...
  /// <inheritdoc />
  void dispatchIndirect(const IVulkanBuffer & batchBuffer, UInt32 batchCount,
  ...
  /// <inheritdoc />
  void dispatchMeshIndirect(const IVulkanBuffer & batchBuffer, UInt32 batchCount,
                            UInt64 offset = 0) const noexcept override;

  /// <inheritdoc />
  void dispatchMeshIndirect(
    const IVulkanBuffer & batchBuffer, const IVulkanBuffer & countBuffer, UInt64 offset = 0,
  ...
  /// <inheritdoc />
  void drawIndirect(const IVulkanBuffer & batchBuffer, UInt32 batchCount,
                    UInt64 offset = 0) const noexcept override;

  /// <inheritdoc />
  void drawIndirect(const IVulkanBuffer & batchBuffer, const IVulkanBuffer & countBuffer,
  ...
  /// <inheritdoc />
  void drawIndexedIndirect(const IVulkanBuffer & batchBuffer, UInt32 batchCount,
                           UInt64 offset = 0) const noexcept override;
  ...
  /// <inheritdoc />
  void pushConstants(const VulkanPushConstantsLayout & layout,
  ...
  /// <inheritdoc />
  void buildAccelerationStructure(VulkanBottomLevelAccelerationStructure & blas,
                                  const SharedPtr<const IVulkanBuffer> scratchBuffer,
                                  const IVulkanBuffer & buffer, UInt64 offset) const override;

  /// <inheritdoc />
  void buildAccelerationStructure(VulkanTopLevelAccelerationStructure & tlas,
                                  const SharedPtr<const IVulkanBuffer> scratchBuffer,
                                  const IVulkanBuffer & buffer, UInt64 offset) const override;

  /// <inheritdoc />
  void updateAccelerationStructure(VulkanBottomLevelAccelerationStructure & blas,
                                   const SharedPtr<const IVulkanBuffer> scratchBuffer,
                                   const IVulkanBuffer & buffer, UInt64 offset) const override;

  /// <inheritdoc />
  void updateAccelerationStructure(VulkanTopLevelAccelerationStructure & tlas,
                                   const SharedPtr<const IVulkanBuffer> scratchBuffer,
                                   const IVulkanBuffer & buffer, UInt64 offset) const override;

  /// <inheritdoc />
  void copyAccelerationStructure(const VulkanBottomLevelAccelerationStructure & from,
                                 const VulkanBottomLevelAccelerationStructure & to,
                                 bool compress = false) const noexcept override;

  /// <inheritdoc />
  void copyAccelerationStructure(const VulkanTopLevelAccelerationStructure & from,
                                 const VulkanTopLevelAccelerationStructure & to,
                                 bool compress = false) const noexcept override;

  /// <inheritdoc />
  void traceRays(UInt32 width, UInt32 height, UInt32 depth,
                 const ShaderBindingTableOffsets & offsets,
                 const IVulkanBuffer & rayGenerationShaderBindingTable,
                 const IVulkanBuffer * missShaderBindingTable,
                 const IVulkanBuffer * hitShaderBindingTable,
                 const IVulkanBuffer * callableShaderBindingTable) const noexcept override;
...
/// </summary>
/// <seealso cref="VulkanCommandBuffer" />
class LITEFX_VULKAN_API VulkanQueue final : public CommandQueue<VulkanCommandBuffer>,
                                            public Resource<VkQueue>
{
...
public:
  ...
  explicit VulkanQueue(const VulkanDevice & device, QueueType type, QueuePriority priority,
                       UInt32 familyId, UInt32 queueId);
...
public:
  /// <inheritdoc />
  SharedPtr<VulkanCommandBuffer> createCommandBuffer(bool beginRecording = false,
  ...
  /// <inheritdoc />
  UInt64 submit(
    const Enumerable<SharedPtr<const VulkanCommandBuffer>> & commandBuffers) const override;
...
class LITEFX_VULKAN_API VulkanRenderPipeline final
  : public RenderPipeline<VulkanPipelineLayout, VulkanShaderProgram, VulkanInputAssembler,
                          VulkanRasterizer>,
...
public:
  ...
  explicit VulkanRenderPipeline(const VulkanRenderPass & renderPass,
...
public:
  ...
  /// <inheritdoc />
  void bind(const VulkanCommandBuffer & commandBuffer,
            Span<const VulkanDescriptorSet *> descriptorSets) const noexcept override;
};
...
class LITEFX_VULKAN_API VulkanComputePipeline final
  : public ComputePipeline<VulkanPipelineLayout, VulkanShaderProgram>,
    public VulkanPipelineState
{
...
public:
  ...
  explicit VulkanComputePipeline(const VulkanDevice & device,
                                 SharedPtr<VulkanPipelineLayout> layout,
                                 SharedPtr<VulkanShaderProgram> shaderProgram,
                                 const String & name = "");
...
class LITEFX_VULKAN_API VulkanRayTracingPipeline final
  : public RayTracingPipeline<VulkanPipelineLayout, VulkanShaderProgram>,
    public VulkanPipelineState
{
...
public:
  ...
  /// <inheritdoc />
  UniquePtr<IVulkanBuffer> allocateShaderBindingTable(
...
public:
  ...
  explicit VulkanRenderPass(
    const VulkanDevice & device, Span<RenderTarget> renderTargets,
  ...
  /// <param name="secondaryCommandBuffers">The number of command buffers that can be used for recording multi-threaded commands during the render pass.</param>
  explicit VulkanRenderPass(
    const VulkanDevice & device, const String & name, Span<RenderTarget> renderTargets,
    Span<RenderPassDependency> inputAttachments = {},
    Optional<DescriptorBindingPoint> inputAttachmentSamplerBinding = std::nullopt,
    UInt32 secondaryCommandBuffers = 1u);
  ...
  /// <param name="secondaryCommandBuffers">The number of command buffers that can be used for recording multi-threaded commands during the render pass.</param>
  explicit VulkanRenderPass(
    const VulkanDevice & device, const VulkanQueue & queue, Span<RenderTarget> renderTargets,
    Span<RenderPassDependency> inputAttachments = {},
    Optional<DescriptorBindingPoint> inputAttachmentSamplerBinding = std::nullopt,
    UInt32 secondaryCommandBuffers = 1u);
  ...
  /// <param name="secondaryCommandBuffers">The number of command buffers that can be used for recording multi-threaded commands during the render pass.</param>
  explicit VulkanRenderPass(
    const VulkanDevice & device, const String & name, const VulkanQueue & queue,
...
/// </remarks>
class LITEFX_VULKAN_API VulkanGraphicsFactory final
  : public GraphicsFactory<
      VulkanDescriptorLayout, IVulkanBuffer, IVulkanVertexBuffer, IVulkanIndexBuffer, IVulkanImage,
      IVulkanSampler, VulkanBottomLevelAccelerationStructure, VulkanTopLevelAccelerationStructure>
{
  LITEFX_IMPLEMENTATION(VulkanGraphicsFactoryImpl);

public:
  using base_type =
    GraphicsFactory<VulkanDescriptorLayout, IVulkanBuffer, IVulkanVertexBuffer, IVulkanIndexBuffer,
                    IVulkanImage, IVulkanSampler, VulkanBottomLevelAccelerationStructure,
                    VulkanTopLevelAccelerationStructure>;
...
public:
  /// <inheritdoc />
  UniquePtr<IVulkanBuffer> createBuffer(
  ...
  /// <inheritdoc />
  UniquePtr<IVulkanVertexBuffer> createVertexBuffer(
    const VulkanVertexBufferLayout & layout, ResourceHeap heap, UInt32 elements = 1,
    ResourceUsage usage = ResourceUsage::Default) const override;

  /// <inheritdoc />
  UniquePtr<IVulkanVertexBuffer> createVertexBuffer(
    const String & name, const VulkanVertexBufferLayout & layout, ResourceHeap heap,
    UInt32 elements = 1, ResourceUsage usage = ResourceUsage::Default) const override;

  /// <inheritdoc />
  UniquePtr<IVulkanIndexBuffer> createIndexBuffer(
    const VulkanIndexBufferLayout & layout, ResourceHeap heap, UInt32 elements,
    ResourceUsage usage = ResourceUsage::Default) const override;

  /// <inheritdoc />
  UniquePtr<IVulkanIndexBuffer> createIndexBuffer(
    const String & name, const VulkanIndexBufferLayout & layout, ResourceHeap heap, UInt32 elements,
    ResourceUsage usage = ResourceUsage::Default) const override;

  /// <inheritdoc />
  UniquePtr<IVulkanImage> createTexture(
  ...
  /// <inheritdoc />
  Enumerable<UniquePtr<IVulkanImage>> createTextures(
  ...
  /// <inheritdoc />
  UniquePtr<IVulkanSampler> createSampler(
  ...
  /// <inheritdoc />
  Enumerable<UniquePtr<IVulkanSampler>> createSamplers(
  ...
  /// <inheritdoc />
  virtual UniquePtr<VulkanBottomLevelAccelerationStructure> createBottomLevelAccelerationStructure(
    StringView name,
    AccelerationStructureFlags flags = AccelerationStructureFlags::None) const override;

  /// <inheritdoc />
  virtual UniquePtr<VulkanTopLevelAccelerationStructure> createTopLevelAccelerationStructure(
    StringView name,
    AccelerationStructureFlags flags = AccelerationStructureFlags::None) const override;
};
...
/// </summary>
class LITEFX_VULKAN_API VulkanDevice final
  : public GraphicsDevice<VulkanGraphicsFactory, VulkanSurface, VulkanGraphicsAdapter,
                          VulkanSwapChain, VulkanQueue, VulkanRenderPass, VulkanRenderPipeline,
                          VulkanComputePipeline, VulkanRayTracingPipeline, VulkanBarrier>,
...
public:
  ...
  explicit VulkanDevice(const VulkanBackend & backend, const VulkanGraphicsAdapter & adapter,
                        UniquePtr<VulkanSurface> && surface, GraphicsDeviceFeatures features = {},
  ...
  /// <param name="extensions">The required extensions the device gets initialized with.</param>
  explicit VulkanDevice(const VulkanBackend & backend, const VulkanGraphicsAdapter & adapter,
                        UniquePtr<VulkanSurface> && surface, Format format,
                        const Size2d & renderArea, UInt32 backBuffers, bool enableVsync = false,
                        GraphicsDeviceFeatures features = {}, Span<String> extensions = {});
...
public:
  ...
  void setDebugName(UInt64 objectHandle, VkDebugReportObjectTypeEXT objectType,
...
public:
  ...
  /// <inheritdoc />
  const VulkanQueue * createQueue(QueueType type,
                                  QueuePriority priority = QueuePriority::Normal) noexcept override;
  ...
  /// <inheritdoc />
  [[nodiscard]] UniquePtr<VulkanFrameBuffer> makeFrameBuffer(
  ...
  /// <inheritdoc />
  void computeAccelerationStructureSizes(const VulkanBottomLevelAccelerationStructure & blas,
                                         UInt64 & bufferSize, UInt64 & scratchSize,
                                         bool forUpdate = false) const override;

  /// <inheritdoc />
  void computeAccelerationStructureSizes(const VulkanTopLevelAccelerationStructure & tlas,
                                         UInt64 & bufferSize, UInt64 & scratchSize,
                                         bool forUpdate = false) const override;
...
public:
  ...
  /// <inheritdoc />
  [[nodiscard]] VulkanRenderPassBuilder buildRenderPass(const String & name,
  ...
  /// <inheritdoc />
  [[nodiscard]] VulkanRenderPipelineBuilder buildRenderPipeline(const VulkanRenderPass & renderPass,
                                                                const String & name) const override;

  /// <inheritdoc />
  [[nodiscard]] VulkanComputePipelineBuilder buildComputePipeline(
    const String & name) const override;

  /// <inheritdoc />
  [[nodiscard]] VulkanRayTracingPipelineBuilder buildRayTracingPipeline(
...
/// </summary>
class LITEFX_VULKAN_API VulkanBackend final : public RenderBackend<VulkanDevice>,
                                              public Resource<VkInstance>
{
...
public:
  ...
  explicit VulkanBackend(const App & app, const Span<String> extensions = {},
                         const Span<String> validationLayers = {});
