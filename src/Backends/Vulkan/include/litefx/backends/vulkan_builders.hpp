...
class LITEFX_VULKAN_API [[nodiscard]] VulkanBarrierBuilder final
...
class LITEFX_VULKAN_API [[nodiscard]] VulkanShaderProgramBuilder final
  : public ShaderProgramBuilder<VulkanShaderProgram>
{
...
protected:
  /// <inheritdoc />
  UniquePtr<VulkanShaderModule> makeShaderModule(
...
class LITEFX_VULKAN_API [[nodiscard]] VulkanRasterizerBuilder final
  : public RasterizerBuilder<VulkanRasterizer>
{
public:
  /// <summary>
...
class LITEFX_VULKAN_API [[nodiscard]] VulkanVertexBufferLayoutBuilder final
  : public VertexBufferLayoutBuilder<VulkanVertexBufferLayout, VulkanInputAssemblerBuilder>
{
public:
  using VertexBufferLayoutBuilder<VulkanVertexBufferLayout,
                                  VulkanInputAssemblerBuilder>::VertexBufferLayoutBuilder;
...
class LITEFX_VULKAN_API [[nodiscard]] VulkanInputAssemblerBuilder final
  : public InputAssemblerBuilder<VulkanInputAssembler>
{
...
class LITEFX_VULKAN_API [[nodiscard]] VulkanDescriptorSetLayoutBuilder final
  : public DescriptorSetLayoutBuilder<VulkanDescriptorSetLayout, VulkanPipelineLayoutBuilder>
{
public:
  /// <summary>
  ...
  explicit VulkanDescriptorSetLayoutBuilder(VulkanPipelineLayoutBuilder & parent, UInt32 space = 0,
...
protected:
  /// <inheritdoc />
  UniquePtr<VulkanDescriptorLayout> makeDescriptor(DescriptorType type, UInt32 binding,
                                                   UInt32 descriptorSize,
                                                   UInt32 descriptors) override;

  /// <inheritdoc />
  UniquePtr<VulkanDescriptorLayout> makeDescriptor(UInt32 binding, FilterMode magFilter,
...
class LITEFX_VULKAN_API [[nodiscard]] VulkanPushConstantsLayoutBuilder final
  : public PushConstantsLayoutBuilder<VulkanPushConstantsLayout, VulkanPipelineLayoutBuilder>
{
public:
  /// <summary>
...
protected:
  /// <inheritdoc />
  UniquePtr<VulkanPushConstantsRange> makeRange(ShaderStage shaderStages, UInt32 offset,
                                                UInt32 size, UInt32 space, UInt32 binding) override;
};
...
/// <seealso cref="VulkanRenderPipeline" />
/// <seealso cref="VulkanComputePipeline" />
class LITEFX_VULKAN_API [[nodiscard]] VulkanPipelineLayoutBuilder final
...
public:
  ...
  VulkanDescriptorSetLayoutBuilder descriptorSet(UInt32 space = 0,
                                                 ShaderStage stages = ShaderStage::Any);
...
/// </summary>
/// <seealso cref="VulkanRenderPipeline" />
class LITEFX_VULKAN_API [[nodiscard]] VulkanRenderPipelineBuilder final
  : public RenderPipelineBuilder<VulkanRenderPipeline>
{
public:
  /// <summary>
  ...
  explicit VulkanRenderPipelineBuilder(const VulkanRenderPass & renderPass,
                                       const String & name = "");
...
/// </summary>
/// <seealso cref="VulkanComputePipeline" />
class LITEFX_VULKAN_API [[nodiscard]] VulkanComputePipelineBuilder final
  : public ComputePipelineBuilder<VulkanComputePipeline>
{
public:
  /// <summary>
...
class LITEFX_VULKAN_API [[nodiscard]] VulkanRayTracingPipelineBuilder final
  : public RayTracingPipelineBuilder<VulkanRayTracingPipeline>
{
public:
  /// <summary>
  ...
  explicit VulkanRayTracingPipelineBuilder(const VulkanDevice & device,
...
class LITEFX_VULKAN_API [[nodiscard]] VulkanRenderPassBuilder final
  : public RenderPassBuilder<VulkanRenderPass>
{
public:
  /// <summary>
  ...
  /// <param name="name">A debug name for the render pass.</param>
  explicit VulkanRenderPassBuilder(const VulkanDevice & device, UInt32 commandBuffers,
