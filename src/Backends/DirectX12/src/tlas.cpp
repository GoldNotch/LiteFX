...
class DirectX12TopLevelAccelerationStructure::DirectX12TopLevelAccelerationStructureImpl
  : public Implement<DirectX12TopLevelAccelerationStructure>
{
public:
...
public:
  DirectX12TopLevelAccelerationStructureImpl(DirectX12TopLevelAccelerationStructure * parent,
    ...
    return m_instances |
           std::views::transform(
             [](const Instance & instance)
             {
               ...
               auto desc =
                 D3D12_RAYTRACING_INSTANCE_DESC{.InstanceID = instance.Id,
                                                ...
                                                .AccelerationStructure =
                                                  blasBuffer == nullptr
                                                    ...
                                                    : blasBuffer->virtualAddress() +
                                                        instance.BottomLevelAccelerationStructure
                                                          ->offset()};
...
UInt64 DirectX12TopLevelAccelerationStructure::offset() const noexcept { return m_impl->m_offset; }
...
void DirectX12TopLevelAccelerationStructure::build(const DirectX12CommandBuffer & commandBuffer,
                                                   SharedPtr<const IDirectX12Buffer> scratchBuffer,
                                                   SharedPtr<const IDirectX12Buffer> buffer,
...
void DirectX12TopLevelAccelerationStructure::update(const DirectX12CommandBuffer & commandBuffer,
                                                    SharedPtr<const IDirectX12Buffer> scratchBuffer,
                                                    SharedPtr<const IDirectX12Buffer> buffer,
                                                    UInt64 offset, UInt64 maxSize)
{
...
void DirectX12TopLevelAccelerationStructure::copy(
  const DirectX12CommandBuffer & commandBuffer,
  DirectX12TopLevelAccelerationStructure & destination, bool compress,
...
void DirectX12TopLevelAccelerationStructure::clear() noexcept { m_impl->m_instances.clear(); }
...
void DirectX12TopLevelAccelerationStructure::doBuild(const ICommandBuffer & commandBuffer,
...
void DirectX12TopLevelAccelerationStructure::doUpdate(const ICommandBuffer & commandBuffer,
                                                      SharedPtr<const IBuffer> scratchBuffer,
...
void DirectX12TopLevelAccelerationStructure::doCopy(const ICommandBuffer & commandBuffer,
