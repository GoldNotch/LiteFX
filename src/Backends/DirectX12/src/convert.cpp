...
Format LiteFX::Rendering::Backends::DX12::getFormat(const DXGI_FORMAT & format)
{
  switch (format)
  {
    ...
    case DXGI_FORMAT_R11G11B10_FLOAT: return Format::B10G11R11_UFLOAT;
    ...
    case DXGI_FORMAT_R9G9B9E5_SHAREDEXP: return Format::E5B9G9R9_UFLOAT;
    case DXGI_FORMAT_BC1_UNORM: return Format::BC1_RGB_UNORM;
    case DXGI_FORMAT_BC1_UNORM_SRGB: return Format::BC1_RGB_SRGB;
    ...
    case DXGI_FORMAT_R10G10B10_XR_BIAS_A2_UNORM: return Format::A2B10G10R10_USCALED;
    ...
    case DXGI_FORMAT_UNKNOWN: return Format::None;
...
DXGI_FORMAT LiteFX::Rendering::Backends::DX12::getFormat(Format format)
{
  switch (format)
  {
    ...
    case Format::A2R10G10B10_UNORM: return DXGI_FORMAT_R10G10B10A2_UNORM;
    case Format::A2R10G10B10_UINT: return DXGI_FORMAT_R10G10B10A2_UINT;
    case Format::B10G11R11_UFLOAT: return DXGI_FORMAT_R11G11B10_FLOAT;
    ...
    case Format::E5B9G9R9_UFLOAT: return DXGI_FORMAT_R9G9B9E5_SHAREDEXP;
    ...
    case Format::A2B10G10R10_USCALED: return DXGI_FORMAT_R10G10B10_XR_BIAS_A2_UNORM;
    ...
    default:
      [[unlikely]] throw InvalidArgumentException("format", "Unsupported format: {0}", format);
  }
}
...
DXGI_FORMAT LiteFX::Rendering::Backends::DX12::getFormat(BufferFormat format)
{
  switch (format)
  {
    case BufferFormat::X16F: return DXGI_FORMAT_R16_FLOAT;
    case BufferFormat::X16I: return DXGI_FORMAT_R16_SINT;
    case BufferFormat::X16U: return DXGI_FORMAT_R16_UINT;
    case BufferFormat::XY16F: return DXGI_FORMAT_R16G16_FLOAT;
    case BufferFormat::XY16I: return DXGI_FORMAT_R16G16_SINT;
    case BufferFormat::XY16U: return DXGI_FORMAT_R16G16_UINT;
    case BufferFormat::X32F: return DXGI_FORMAT_R32_FLOAT;
    case BufferFormat::X32I: return DXGI_FORMAT_R32_SINT;
    case BufferFormat::X32U: return DXGI_FORMAT_R32_UINT;
    case BufferFormat::XY32F: return DXGI_FORMAT_R32G32_FLOAT;
    case BufferFormat::XY32I: return DXGI_FORMAT_R32G32_SINT;
    case BufferFormat::XY32U: return DXGI_FORMAT_R32G32_UINT;
    case BufferFormat::XYZ32F: return DXGI_FORMAT_R32G32B32_FLOAT;
    case BufferFormat::XYZ32I: return DXGI_FORMAT_R32G32B32_SINT;
    case BufferFormat::XYZ32U: return DXGI_FORMAT_R32G32B32_UINT;
    case BufferFormat::XYZW32F: return DXGI_FORMAT_R32G32B32A32_FLOAT;
    case BufferFormat::XYZW32I: return DXGI_FORMAT_R32G32B32A32_SINT;
    case BufferFormat::XYZW32U: return DXGI_FORMAT_R32G32B32A32_UINT;
    case BufferFormat::XYZW16F: return DXGI_FORMAT_R16G16B16A16_FLOAT;
    case BufferFormat::XYZW16I: return DXGI_FORMAT_R16G16B16A16_SINT;
    case BufferFormat::XYZW16U: return DXGI_FORMAT_R16G16B16A16_UINT;
    default:
      [[unlikely]] throw InvalidArgumentException("format", "Unsupported format: {0}.", format);
  }
}
...
{
  return format == Format::A8B8G8R8_SRGB || format == Format::B8G8R8A8_SRGB ||
         format == Format::B8G8R8_SRGB || format == Format::BC1_RGBA_SRGB ||
         format == Format::BC1_RGB_SRGB || format == Format::BC2_SRGB ||
         format == Format::BC3_SRGB || format == Format::BC7_SRGB ||
         format == Format::R8G8B8A8_SRGB || format == Format::R8G8B8_SRGB ||
         format == Format::R8G8_SRGB || format == Format::R8_SRGB;
}
...
D3D12_RESOURCE_DIMENSION LiteFX::Rendering::Backends::DX12::getImageType(ImageDimensions dimensions)
{
  switch (dimensions)
  {
    case ImageDimensions::DIM_1: return D3D12_RESOURCE_DIMENSION_TEXTURE1D;
    case ImageDimensions::DIM_2:
    case ImageDimensions::CUBE: return D3D12_RESOURCE_DIMENSION_TEXTURE2D;
    case ImageDimensions::DIM_3: return D3D12_RESOURCE_DIMENSION_TEXTURE3D;
    default: throw std::invalid_argument("Unsupported image dimensionality.");
  }
}
...
PolygonMode LiteFX::Rendering::Backends::DX12::getPolygonMode(const D3D12_FILL_MODE & mode)
{
  switch (mode)
  {
    case D3D12_FILL_MODE::D3D12_FILL_MODE_WIREFRAME: return PolygonMode::Wireframe;
    case D3D12_FILL_MODE::D3D12_FILL_MODE_SOLID: return PolygonMode::Solid;
...
D3D12_FILL_MODE LiteFX::Rendering::Backends::DX12::getPolygonMode(PolygonMode mode)
{
  switch (mode)
  {
    case PolygonMode::Solid: return D3D12_FILL_MODE::D3D12_FILL_MODE_SOLID;
    case PolygonMode::Wireframe: return D3D12_FILL_MODE::D3D12_FILL_MODE_WIREFRAME;
    default: throw std::invalid_argument("Unsupported polygon mode.");
  }
}
...
CullMode LiteFX::Rendering::Backends::DX12::getCullMode(const D3D12_CULL_MODE & mode)
{
  switch (mode)
  {
    case D3D12_CULL_MODE::D3D12_CULL_MODE_BACK: return CullMode::BackFaces;
    case D3D12_CULL_MODE::D3D12_CULL_MODE_FRONT: return CullMode::FrontFaces;
    case D3D12_CULL_MODE::D3D12_CULL_MODE_NONE: return CullMode::Disabled;
...
D3D12_CULL_MODE LiteFX::Rendering::Backends::DX12::getCullMode(CullMode mode)
{
  switch (mode)
  {
    case CullMode::BackFaces: return D3D12_CULL_MODE::D3D12_CULL_MODE_BACK;
    case CullMode::FrontFaces: return D3D12_CULL_MODE::D3D12_CULL_MODE_FRONT;
    case CullMode::Disabled: return D3D12_CULL_MODE::D3D12_CULL_MODE_NONE;
    default: throw std::invalid_argument("Unsupported cull mode.");
  }
}

PrimitiveTopology LiteFX::Rendering::Backends::DX12::getPrimitiveTopology(
...
D3D12_PRIMITIVE_TOPOLOGY LiteFX::Rendering::Backends::DX12::getPrimitiveTopology(
...
D3D12_PRIMITIVE_TOPOLOGY_TYPE LiteFX::Rendering::Backends::DX12::getPrimitiveTopologyType(
  PrimitiveTopology topology)
{
  switch (topology)
  {
...
LPCTSTR LITEFX_DIRECTX12_API
LiteFX::Rendering::Backends::DX12::getSemanticName(AttributeSemantic semantic)
{
  switch (semantic)
  {
    case LiteFX::Rendering::AttributeSemantic::Binormal: return "BINORMAL";
    case LiteFX::Rendering::AttributeSemantic::BlendIndices: return "BLENDINDICES";
    case LiteFX::Rendering::AttributeSemantic::BlendWeight: return "BLENDWEIGHT";
    case LiteFX::Rendering::AttributeSemantic::Color: return "COLOR";
    case LiteFX::Rendering::AttributeSemantic::Normal: return "NORMAL";
    case LiteFX::Rendering::AttributeSemantic::Position: return "POSITION";
    case LiteFX::Rendering::AttributeSemantic::TransformedPosition: return "POSITIONT";
    case LiteFX::Rendering::AttributeSemantic::PointSize: return "PSIZE";
    case LiteFX::Rendering::AttributeSemantic::Tangent: return "TANGENT";
    case LiteFX::Rendering::AttributeSemantic::TextureCoordinate: return "TEXCOORD";
    default:
      [[unlikely]] throw InvalidArgumentException("semantic", "Unsupported semantic {0}.",
                                                  std::to_underlying(semantic));
  }
}
...
D3D12_COMPARISON_FUNC LITEFX_DIRECTX12_API
LiteFX::Rendering::Backends::DX12::getCompareOp(CompareOperation compareOp)
{
  switch (compareOp)
  {
    ...
    default:
      [[unlikely]] throw InvalidArgumentException("compareOp", "Unsupported compare operation.");
  }
}

D3D12_STENCIL_OP LITEFX_DIRECTX12_API
LiteFX::Rendering::Backends::DX12::getStencilOp(StencilOperation stencilOp)
{
  switch (stencilOp)
  {
    ...
    default:
      [[unlikely]] throw InvalidArgumentException("stencilOp", "Unsupported stencil operation.");
  }
}

D3D12_BLEND LITEFX_DIRECTX12_API
LiteFX::Rendering::Backends::DX12::getBlendFactor(BlendFactor blendFactor)
{
  switch (blendFactor)
  {
    ...
    default:
      [[unlikely]] throw InvalidArgumentException("blendFactor", "Unsupported blend factor.");
  }
}

D3D12_BLEND_OP LITEFX_DIRECTX12_API
LiteFX::Rendering::Backends::DX12::getBlendOperation(BlendOperation blendOperation)
{
  switch (blendOperation)
  {
    ...
    default:
      [[unlikely]] throw InvalidArgumentException("blendOperation", "Unsupported blend operation.");
  }
}

D3D12_BARRIER_SYNC LITEFX_DIRECTX12_API
LiteFX::Rendering::Backends::DX12::getPipelineStage(PipelineStage pipelineStage)
{
  ...
  if (LITEFX_FLAG_IS_SET(pipelineStage, PipelineStage::InputAssembly))
    sync |=
      D3D12_BARRIER_SYNC_INDEX_INPUT; // D3D12_BARRIER_SYNC_INPUT_ASSEMBLER appears to be deprecated but I could not find any info about the deprecation.
...
D3D12_BARRIER_ACCESS LITEFX_DIRECTX12_API
LiteFX::Rendering::Backends::DX12::getResourceAccess(ResourceAccess resourceAccess)
{
...
D3D12_BARRIER_LAYOUT LITEFX_DIRECTX12_API
LiteFX::Rendering::Backends::DX12::getImageLayout(ImageLayout imageLayout)
{
  switch (imageLayout)
  {
    ...
    default:
      [[unlikely]] throw InvalidArgumentException("imageLayout", "Unsupported image layout.");
  }
}
