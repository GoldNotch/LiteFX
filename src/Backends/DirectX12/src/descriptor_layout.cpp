...
class DirectX12DescriptorLayout::DirectX12DescriptorLayoutImpl
  : public Implement<DirectX12DescriptorLayout>
{
public:
...
public:
  DirectX12DescriptorLayoutImpl(DirectX12DescriptorLayout * parent, DescriptorType type,
                                UInt32 binding, size_t elementSize, UInt32 descriptors, bool local)
    : base(parent)
    ...
    , m_local(local)
  {
    switch (m_descriptorType)
    {
      ...
      case DescriptorType::AccelerationStructure:
        ...
        break;
      default: m_bufferType = BufferType::Other;
    }
  }

  DirectX12DescriptorLayoutImpl(DirectX12DescriptorLayout * parent,
                                UniquePtr<IDirectX12Sampler> && staticSampler, UInt32 binding,
                                bool local)
...
DirectX12DescriptorLayout::DirectX12DescriptorLayout(DescriptorType type, UInt32 binding,
...
bool DirectX12DescriptorLayout::local() const noexcept { return m_impl->m_local; }

size_t DirectX12DescriptorLayout::elementSize() const noexcept { return m_impl->m_elementSize; }

UInt32 DirectX12DescriptorLayout::descriptors() const noexcept { return m_impl->m_descriptors; }

UInt32 DirectX12DescriptorLayout::binding() const noexcept { return m_impl->m_binding; }

BufferType DirectX12DescriptorLayout::type() const noexcept { return m_impl->m_bufferType; }
