...
class DirectX12VertexBufferLayout::DirectX12VertexBufferLayoutImpl
  : public Implement<DirectX12VertexBufferLayout>
{
public:
...
public:
  DirectX12VertexBufferLayoutImpl(DirectX12VertexBufferLayout * parent, size_t vertexSize,
                                  UInt32 binding)
    : base(parent)
...
size_t DirectX12VertexBufferLayout::elementSize() const noexcept { return m_impl->m_vertexSize; }

UInt32 DirectX12VertexBufferLayout::binding() const noexcept { return m_impl->m_binding; }

BufferType DirectX12VertexBufferLayout::type() const noexcept { return m_impl->m_bufferType; }

Enumerable<const BufferAttribute *> DirectX12VertexBufferLayout::attributes() const noexcept
{
  return m_impl->m_attributes |
         std::views::transform([](const UniquePtr<BufferAttribute> & attribute)
