...
class DirectX12IndexBufferLayout::DirectX12IndexBufferLayoutImpl
  : public Implement<DirectX12IndexBufferLayout>
{
public:
...
UInt32 DirectX12IndexBufferLayout::binding() const noexcept { return m_impl->m_binding; }

BufferType DirectX12IndexBufferLayout::type() const noexcept { return m_impl->m_bufferType; }

IndexType DirectX12IndexBufferLayout::indexType() const noexcept { return m_impl->m_indexType; }
