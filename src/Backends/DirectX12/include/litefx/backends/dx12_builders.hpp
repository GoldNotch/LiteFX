...
class LITEFX_DIRECTX12_API [[nodiscard]] DirectX12BarrierBuilder final
...
public:
  ...
  /// <inheritdoc />
  void setupImageBarrier(IImage & image, ResourceAccess before, ResourceAccess after,
                         ImageLayout layout, UInt32 level, UInt32 levels, UInt32 layer,
                         UInt32 layers, UInt32 plane) override;
};
...
class LITEFX_DIRECTX12_API [[nodiscard]] DirectX12ShaderProgramBuilder final
  : public ShaderProgramBuilder<DirectX12ShaderProgram>
{
...
protected:
  /// <inheritdoc />
  UniquePtr<DirectX12ShaderModule> makeShaderModule(
    ShaderStage type, const String & fileName, const String & entryPoint,
    const Optional<DescriptorBindingPoint> & shaderLocalDescriptor) override;
...
class LITEFX_DIRECTX12_API [[nodiscard]] DirectX12RasterizerBuilder final
  : public RasterizerBuilder<DirectX12Rasterizer>
{
public:
  /// <summary>
...
class LITEFX_DIRECTX12_API [[nodiscard]] DirectX12VertexBufferLayoutBuilder final
  : public VertexBufferLayoutBuilder<DirectX12VertexBufferLayout, DirectX12InputAssemblerBuilder>
{
public:
  using VertexBufferLayoutBuilder<DirectX12VertexBufferLayout,
                                  DirectX12InputAssemblerBuilder>::VertexBufferLayoutBuilder;
...
class LITEFX_DIRECTX12_API [[nodiscard]] DirectX12InputAssemblerBuilder final
  : public InputAssemblerBuilder<DirectX12InputAssembler>
{
...
class LITEFX_DIRECTX12_API [[nodiscard]] DirectX12DescriptorSetLayoutBuilder final
  : public DescriptorSetLayoutBuilder<DirectX12DescriptorSetLayout, DirectX12PipelineLayoutBuilder>
{
public:
  /// <summary>
  ...
  explicit DirectX12DescriptorSetLayoutBuilder(DirectX12PipelineLayoutBuilder & parent,
                                               UInt32 space = 0,
...
protected:
  /// <inheritdoc />
  UniquePtr<DirectX12DescriptorLayout> makeDescriptor(DescriptorType type, UInt32 binding,
                                                      UInt32 descriptorSize,
                                                      UInt32 descriptors) override;

  /// <inheritdoc />
  UniquePtr<DirectX12DescriptorLayout> makeDescriptor(UInt32 binding, FilterMode magFilter,
...
class LITEFX_DIRECTX12_API [[nodiscard]] DirectX12PushConstantsLayoutBuilder final
  : public PushConstantsLayoutBuilder<DirectX12PushConstantsLayout, DirectX12PipelineLayoutBuilder>
{
public:
  /// <summary>
  ...
  explicit DirectX12PushConstantsLayoutBuilder(DirectX12PipelineLayoutBuilder & parent,
                                               UInt32 size);
...
protected:
  /// <inheritdoc />
  UniquePtr<DirectX12PushConstantsRange> makeRange(ShaderStage shaderStages, UInt32 offset,
...
/// <seealso cref="DirectX12RenderPipeline" />
/// <seealso cref="DirectX12ComputePipeline" />
class LITEFX_DIRECTX12_API [[nodiscard]] DirectX12PipelineLayoutBuilder final
...
public:
  ...
  DirectX12DescriptorSetLayoutBuilder descriptorSet(UInt32 space = 0,
                                                    ShaderStage stages = ShaderStage::Any);
...
/// </summary>
/// <seealso cref="DirectX12RenderPipeline" />
class LITEFX_DIRECTX12_API [[nodiscard]] DirectX12RenderPipelineBuilder final
  : public RenderPipelineBuilder<DirectX12RenderPipeline>
{
public:
  /// <summary>
  ...
  explicit DirectX12RenderPipelineBuilder(const DirectX12RenderPass & renderPass,
                                          const String & name = "");
...
/// </summary>
/// <seealso cref="DirectX12ComputePipeline" />
class LITEFX_DIRECTX12_API [[nodiscard]] DirectX12ComputePipelineBuilder final
  : public ComputePipelineBuilder<DirectX12ComputePipeline>
{
public:
  /// <summary>
  ...
  explicit DirectX12ComputePipelineBuilder(const DirectX12Device & device,
                                           const String & name = "");
...
class LITEFX_DIRECTX12_API [[nodiscard]] DirectX12RayTracingPipelineBuilder final
  : public RayTracingPipelineBuilder<DirectX12RayTracingPipeline>
{
public:
  /// <summary>
  ...
  explicit DirectX12RayTracingPipelineBuilder(const DirectX12Device & device,
...
class LITEFX_DIRECTX12_API [[nodiscard]] DirectX12RenderPassBuilder final
  : public RenderPassBuilder<DirectX12RenderPass>
{
public:
  /// <summary>
  ...
  explicit DirectX12RenderPassBuilder(const DirectX12Device & device,
  ...
  /// <param name="name">A debug name for the render pass.</param>
  explicit DirectX12RenderPassBuilder(const DirectX12Device & device, UInt32 commandBuffers,
                                      const String & name = "") noexcept;
...
protected:
  /// <inheritdoc />
  RenderPassDependency makeInputAttachment(DescriptorBindingPoint binding,
                                           const RenderTarget & renderTarget) override;
};
